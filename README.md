...
Skill testing untuk Claude Code, Antigravity, OpenCode, dan Codex. Unit test dan integration test wajib ada dan mencakup perilaku dalam lingkup tugas; coverage yang sudah memadai dapat digunakan kembali. Security testing juga wajib ada, dengan cakupan sesuai stack, input, batas kepercayaan, dan risiko proyek. E2E frontend wajib untuk semua case perilaku pengguna dalam lingkup tugas, termasuk alur berhasil, validasi, error, dan edge case yang relevan. E2E backend tetap opsional jika integration coverage memadai. Skill menyediakan cara menjalankan test dan mewajibkan agent menjalankan seluruh suite setelah menambah atau mengubah test.
